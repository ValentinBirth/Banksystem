...
public class Kunde implements Comparable<Kunde>, Serializable {
	...
	public Kunde(String vorname, String nachname, String adresse, LocalDate gebdat) {
		...
		//Shutdownhook einrichten: Was passieren soll, wenn das Programm beendet wird:
	...
	/**
	 * liefert eine StringProperty für Adresse zurück
	...
	static   //statischer Block, statischer Initialisierer
	{
	...
	private static class Zerstoerer implements Runnable
	{
		@Override
		public void run() {
			//hier Aufräumarbeiten erledigen, z.B. Datenbankverbindung schließen o.ä.
